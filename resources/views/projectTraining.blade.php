...
@section('main-contant')
    ...
    <section class="about-us-section">
        ...
        {{-- <div class="about-us-content">
            <h1><b>Project & Plcaement Training</b></h1>
        </div> --}}
    </section>
        ...
        <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-8 col-sm-12 text-center justify-content-center">
                        <div class="card-section-summer" >
                            <div class="d-flex">
                                <img src="{{ asset('ekimage/image/projectimage.png') }}" alt=""
                                    class="img-fluid">
                                <h3 class="display-1 fw-bold " style=" text-shadow: 2px 3px 5px red;">PROJECT &nbsp;TRAINING</h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-2 col-sm-12"></div>
            ...
            <div class="row mt-2">
                ...
                <div class="col-lg-8 col-md-8 col-sm-12 col-12"   data-aos="fade-up" data-aos-dratation="3000">
                    <h2 id="h2"   data-aos="fade-down-right" data-aos-dratation="3000">Welcome to the Ekana’s Project Training in Lucknow!</h2>
                    <br>
    ...
    <div class="container-desc bg-white">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-10 col-md-12 col-sm-12 mt-3"   data-aos="zoom-in" data-aos-dratation="3000">
                    <p style="color:rgba(103, 102, 102, 1);text-align:justify;">
                        Our Project Training Program in Lucknow is carefully crafted to provide hands-on experience and
                        practical knowledge in various domains. We understand the importance of real-world projects in
                        enhancing skills, and thus, our program focuses, on project-based learning to ensure a holistic
            ...
            <div class="row">
                ...
                <div class="col-lg-10 col-md-12 col-sm-12 mt-3"   data-aos="zoom-in" data-aos-dratation="3000">
                    <p style="color:rgba(103, 102, 102, 1);text-align:justify;">
                        Upon Successful completion of the project training program, students will receive certification that
            ...
            <div class="row">
                ...
                <div class="col-lg-10 col-md-12 col-sm-12 mt-3"   data-aos="zoom-in" data-aos-dratation="3000">
                    ...
                    <ul>
                        ...
                        <li>
                            <p>Ability to work on real world projects independently.</p>
                        </li>
                        <li>
