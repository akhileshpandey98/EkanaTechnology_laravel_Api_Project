...
@section('main-contant')
    ...
    <section class="about-us-section">
        ...
        {{-- <div class="about-us-content">
            <h1><b>Internship & Plcaement Training</b></h1>
        </div> --}}
    </section>

    <!--The Internship section start-->
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-8 col-sm-12 text-center justify-content-center">
                        <div class="card-section-summer">
                            <div class="d-flex">
                                <img src="{{ asset('ekimage/image/Internshipimage.png') }}" alt=""
                                    class="img-fluid">
                                <h3 class="display-1 fw-bold " style=" text-shadow: 2px 3px 5px red;">INTERNSHIP TRAINING
                                </h3>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row mt-2">
                ...
                <div class="col-lg-8 col-md-8 col-sm-12 col-12" data-aos="fade-up" data-aos-dratation="3000">
                    <h2 id="h2">Welcome to the Ekana’s
                        Internship Training in Lucknow!</h2>
                    <br>
    ...
    <div class="container-desc bg-white">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-10 col-md-12 col-sm-12 mt-3" data-aos="zoom-in" data-aos-dratation="3000">
                    <p style="color:rgba(103, 102, 102, 1);text-align:justify;">
                        Our Internship Training Program in Lucknow is carefully crafted to provide hands-on experience and
                        practical knowledge in various domains. We understand the importance of real-world Internships in
                        enhancing skills, and thus, our program focuses, on Internship-based learning to ensure a holistic
            ...
            <div class="row">
                ...
                <div class="col-lg-10 col-md-12 col-sm-12 mt-3" data-aos="zoom-in" data-aos-dratation="3000">
                    <p style="color:rgba(103, 102, 102, 1);text-align:justify;">
                        Upon Successful completion of the Internship training program, students will receive certification
                        that
            ...
            <div class="row">
                ...
                <div class="col-lg-10 col-md-12 col-sm-12 mt-3" data-aos="zoom-in" data-aos-dratation="3000">
                    ...
                    <ul>
                        ...
                        <li>
                            <p>Ability to work on real world Internships independently.</p>
                        </li>
                        <li>
    ...
    <!-- Popular Courses -->
    <div class="container">
        <h2 class="text-center"><b class="h2">Additional Benefits</b>
        </h2>
        ...
        <div class="row" data-aos="zoom-in" data-aos-dratation="3000">
            ...
            <div class="col-lg-3 col-md-6 col-sm-12 mb-3 text-center">
                <div class="card" style="height: 3.5rem;width:100%;">
                    <h5> Internship file according to Internship</h5>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-12 mb-3 text-center">
                <div class="card" style="height: 3.5rem;width:100%;">
