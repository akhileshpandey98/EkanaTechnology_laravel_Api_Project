...
<div class="container">
        <div class="row">
            ...
            <h1 class="mt-4 fw-bold text-center">Terms and Conditions of <code class="text-danger">[Ekana Technologies]</code></h1>
            <p class="mt-2">Welcome to Ekana Technology Pvt. Ltd.! By accessing our website and services, you agree to
                the
            ...
            <p>Our website is provided by: <br>
                <a href="https://www.google.com/maps/place/Ekana+Technologies+Pvt+Ltd+16/286,+Sector-17,+Mandi+Road,+Munsipuliya,+Indra+Nagar,+Lucknow,+226016"
                    target="_blank">
                    <code>[Ekana Technologies Pvt Ltd, 16/286, Sector-17, Mandi Road, Munsipuliya, Indra Nagar, Lucknow,
                        226016]</code></a>
            </p>
            {{-- <p><strong>Contact email: </strong><a href="info@ekanatechnologies.com"><code>[info@ekanatechnologies.com]</code></a></p> --}}
            <p><strong>Contact email: </strong><a href="mailto:info@ekanatechnologies.com?subject=Inquiry&body=Hello,%20I%20would%20like%20to%20know%20more%20about%20your%20services."><code>[info@ekanatechnologies.com]</code></a></p>

            <p>This document was generated with the use of the <a
                    href="#">Terms and Conditions generator</a>.</p>
            ...
            <p>Please note that some provisions may only apply to certain categories of users. In particular, certain
                provisions may only apply to consumers or to those users that do not qualify as consumers. Such limitations
                are always explicitly mentioned within each affected clause. In the absence of any such mention, clauses
            ...
            <p>To use the service, you can register or create an account by providing complete and truthful information. You
                can also use the service without an account, but this might limit some features.</p>
            <p>You are responsible for keeping your login details confidential and must choose passwords that meet the
                highest standards of strength as allowed by our website.</p>
            <p>By registering, you agree to take full responsibility for all activities under your username and password.
                <br>
                You must immediately inform us using the contact details in this document if you believe your personal
                information, account, or login details have been violated, disclosed, or stolen.
            </p>
            <h4>Conditions for account registration</h4>
            <p>Registration of accounts on our website is subject to the conditions outlined below. By registering, you
                agree to meet such conditions.</p>
            <ul>
            ...
            <p>You may not use such content in any way that is not necessary or implied for the proper use of the service.
            </p>
            <p>Specifically, but without limitation, you may not copy, download, share (beyond the limits mentioned below),
                modify, translate, transform, publish, transmit, sell, sublicense, edit, transfer, assign to third parties,
                or create derivative works from the content on our website. You also cannot allow any third party to do so
                through your account or device, even unknowingly.</p>
            ...
            <p>Through our website, you may access external resources provided by third parties. You acknowledge and accept
                that we have no control over these resources and are not responsible for their content or availability.</p>
            <p>Conditions for third-party resources, including any rights granted in their content, are governed by those
                third parties' terms and conditions or by applicable law.</p>
            ...
            <p>We reserve the right to protect our interests by denying you access to our website or service, terminating
                contracts, and reporting any misconduct to the appropriate authorities if you are involved in or suspected
                of the following:</p>
            <ul>
            ...
            <h3>Paid products</h3>
            <p>Some of our products require payment. Details about fees, duration, and conditions are described below and in
                the dedicated sections of our website.</p>
            <h3>Product description</h3>
            <p>Prices, descriptions, and availability of products are detailed in the relevant sections of our website and
            ...
            <ul>
                <li>submitting an order determines the contract conclusion and obligates you to pay the specified price,
                    taxes, and any additional fees and expenses outlined on the order page;</li>
            ...
            <p>Certain payment methods might have additional conditions or fees. In these cases, more information can be
                found in the related section of our website.</p>
            <p><code>[add more details about payment methods]</code></p>
            <h3>Retention of product ownership</h3>
            <p>Until payment of the total purchase price is received by us, any products ordered will not become your
                property.</p>
            <h3>Delivery</h3>
            <p>Products are delivered to the address provided by you and in the manner outlined in the order summary.</p>
            <p>Upon delivery, please check the content and report any issues promptly using the contact details provided in
                this document or as outlined in the delivery note. If the parcel appears visibly damaged, you may refuse to
                accept it.</p>
            ...
            <p>We are not liable for delivery errors due to incorrect or incomplete information provided by you during the
                purchasing process nor for any damage or delays after delivery to a carrier organized by you and not offered
                or recommended by us.</p>
            <p>If the goods are not received or collected at the time or within the period specified, they will be returned
                to us. We will contact you to schedule a second delivery attempt or to agree on a future course of action.
            </p>
            ...
            <p>Unless exceptions apply, if you qualify as a European consumer, you have the right to withdraw from a
                contract within a specified period (usually 14 days), without giving any reason. If you don’t fit this
            ...
            <ul>
                ...
                <li>for multiple goods ordered together or delivered separately, the withdrawal period ends 14 days after
                    you or a designated third party acquires physical possession of the last good.</li>
            </ul>
            ...
            <p>However, any additional costs resulting from choosing a delivery method other than our standard option will
                not be reimbursed.</p>
            ...
            <p>Unless we have offered to collect the goods, you must return them to us or to a person authorized by us
                without delay and no later than 14 days after notifying us of your decision to withdraw from the contract.
            </p>
            <p>Your deadline is met if you hand the goods to the carrier or return them as instructed before the 14-day
                period expires. We may withhold reimbursement until we receive the goods or until you provide evidence of
                returning them, whichever occurs first.</p>
            ...
            <p>Unless exceptions apply, if you qualify as a consumer in the United Kingdom, you have the right to withdraw
                from a contract within a specified period (usually 14 days), without giving any reason. If you do not fit
                this qualification, you cannot benefit from the rights described in this section.</p>
            <h4>Exercising your right to cancel</h4>
            <p>To withdraw from a contract, you must inform us clearly of your decision. This can be done using a
                cancellation form or by any other clear statement. Make sure to do this before the cancellation period ends.
            </p>
            ...
            <ul>
                <li>for goods, the cancellation period ends 14 days after you or a designated third party takes physical
                    possession of the goods;</li>
                <li>for multiple goods ordered together or delivered separately, the cancellation period ends 14 days after
                    you or a designated third party acquires physical possession of the last good.</li>
            </ul>
            ...
            <p>You agree to indemnify us and our affiliates, officers, directors, and employees from any claims or demands
                made by third parties due to or in connection with any culpable violation of these terms or third-party
                rights related to your use of the service to the extent allowed by law.</p>
            ...
            <p>However, this exclusion does not apply to damages affecting life, health, or physical integrity, damages
                ...
                website has been used appropriately and correctly by you.</p>
            <p>Unless damages stem from intentional or gross negligence, or they impact life, health, or physical integrity,
                our liability is limited to typical and foreseeable damages at the time the contract was entered into.</p>
            <h3>US users</h3>
            <h4>Disclaimer of warranties</h4>
            <p>Our website is provided on an “as is” and “as available” basis. When you use our service, you are doing so at
                your own risk. We explicitly state that we are not making any promises or guarantees, whether they are
                express, implied, or even required by law. These include assurances about the quality of the service, its
                suitability for your specific needs, or whether it infringes on anyone else's rights. Please keep in mind
                that any advice or information you receive from us or through our service does not create any warranties
                beyond what we have explicitly stated here.</p>
            <p>Additionally, while we strive to provide accurate and reliable content, we cannot guarantee that it is always
                going to be the case. We do not guarantee that the service will always meet your requirements or be
                available when you need it. There might be interruptions, or it might not function correctly due to factors
                beyond our control. While we do our best to keep everything running smoothly, we cannot ensure that the
                service will be free of harmful elements like viruses. If you choose to download any content from our
                service, you are assuming the risk, and we are not responsible for any damage it might cause to your devices
                or data.</p>
            <p>We do not endorse or guarantee any products or services advertised through our service or any links we
                provide. We are not involved in any transactions between you and third-party providers, so any interactions
                or agreements you make with them are solely your responsibility.</p>
            <p>Our service might not always be accessible or may not work correctly with your web browser, mobile device, or
                operating system. While we strive to provide a seamless experience, we cannot guarantee it in every
                situation. As such, we want to clarify that we cannot be held responsible for any perceived or actual
                damages that result from issues related to the content, operation, or use of our service.</p>
            <p>While we may have certain exclusions and limitations in our agreement, these may not apply to you depending
                on the laws of your jurisdiction. Federal law, as well as laws in some states and other jurisdictions, may
                offer protections that supersede our disclaimers and exclusions. This means that you may have specific legal
                rights that are not affected by our agreement. It is essential to understand your rights, as they may vary
                from state to state or country to country. We want to emphasize that any disclaimers or exclusions in our
                agreement will only be enforced to the extent permitted by applicable law.</p>
            <h4>Limitation of liability</h4>
            ...
            <ul>
                <li>any indirect, punitive, incidental, special, consequential, or exemplary damages arising from or related
                    to your use of, or inability to use, the service. This includes damages for loss of profits, goodwill,
                    use, data, or other intangible losses;</li>
                <li>any damage, loss, or injury resulting from hacking, tampering, or unauthorized access to your account or
                    the information within it;</li>
                ...
                <li>defamatory, offensive, or illegal conduct of any user or third party. Our liability is limited to the
                    amount you have paid us in the preceding 12 months, or the duration of your agreement with us, whichever
                    is shorter.</li>
            </ul>
            ...
            <p>Please note that in some jurisdictions, the exclusion or limitation of incidental or consequential damages
                may not be allowed. This means that these limitations or exclusions might not apply to you. You have
                specific legal rights, which may vary depending on your jurisdiction. The disclaimers, exclusions, and
                limitations of liability outlined here may not apply to the extent prohibited by applicable law.</p>
            <h4>Indemnification</h4>
            <p>By using and accessing the service, you agree to defend, indemnify, and hold us, our subsidiaries,
                affiliates, officers, directors, agents, co-branders, partners, suppliers, and employees harmless from any
                claims, damages, losses, liabilities, costs, or expenses, including legal fees, arising from:</p>
            <ul>
            ...
            <h3>No waiver</h3>
            <p>Our failure to assert any right or provision under these terms does not waive that right or provision. No
                waiver will constitute a continuing waiver of such term or any other term.</p>
            <h3>Service interruption</h3>
            <p>To maintain the best service level, we reserve the right to interrupt the service for maintenance, updates,
                or other changes, with appropriate notification.</p>
            <p>We may suspend or discontinue the service within legal limits. If discontinued, we will assist you in
                withdrawing personal data and respect your rights regarding continued product use and compensation under
                applicable law.</p>
            <p>The service may be unavailable due to events beyond our reasonable control, such as infrastructure breakdowns
                or blackouts.</p>
            ...
            <p>All trademarks, whether nominal or figurative, and any other marks, trade names, service marks, word marks,
                illustrations, images, or logos associated with our website, are and remain the exclusive property of us or
                our licensors. These are also protected by applicable laws and international treaties related to
            ...
            <p>You cannot assign or transfer your rights or obligations under these terms without our written permission.
            </p>
            <h3>Contact</h3>
            <p>All communications regarding the use of our website must be sent using the contact information provided in
                this document.</p>
            <h3>Severability</h3>
            ...
            <h4>US users</h4>
            <p>Any invalid or unenforceable provision will be interpreted to the extent reasonably required to render it
                valid, enforceable, and consistent with its original intent. This document constitutes the entire agreement
                between you and us and supersedes all other communications, including but not limited to prior agreements
                concerning such subject matter, to the fullest extent permitted by law.</p>
            <h4>EU users</h4>
            <p>If any provision of this document is void, invalid, or unenforceable, we both agree to do our best to find,
                in an amicable way, an agreement on valid and enforceable provisions. <br>
                In case of failure to do so, the void, invalid, or unenforceable provisions will be replaced by the
                applicable statutory provisions.</p>
            <p>Regardless of the above, the nullity, invalidity, or impossibility of enforcing a particular provision of
                this document will not nullify the entire agreement, unless the severed provisions are essential for it, or
                of such importance that we both would not have entered into the contract if we had known that the provision
                would not be valid, or in cases where the remaining provisions would translate into an unacceptable hardship
                for you or us.</p>
            <h3>Governing law</h3>
            <p>These terms are governed by the law of the place where we are based, as outlined in the relevant section of
                this document, without regard to conflict of laws principles.</p>
            ...
            <h4>UK consumers</h4>
            <p>If you are a consumer based in England and Wales, you may bring legal proceedings related to these terms in
                the English and Welsh courts. If you are a consumer based in Scotland, you may bring legal proceedings in
                either the Scottish or the English courts. If you are a consumer based in Northern Ireland, you may bring
                legal proceedings in either the Northern Irish or the English courts.</p>
            <h4>US users</h4>
            <p>We both agree to waive any right to trial by jury in any court in connection with any action or litigation.
                <br>
                Any claims under these terms shall proceed individually and we both agree not to join in a class action or
                other proceeding with or on behalf of others.
            </p>
            <h3>US users</h3>
            <h4>Surviving provisions</h4>
            <p>Our agreement will continue in effect until it is terminated by either our website or you. Upon termination,
                the provisions contained in this document that by their context are intended to survive termination or
                expiration will survive, including but not limited to the following:</p>
            <ul>
                <li>your grant of licenses under this document will survive indefinitely;</li>
                <li>your indemnification obligations will survive for a period of five years from the date of termination;
                </li>
            ...
            <p>Therefore, European consumers or consumers based in Norway, Iceland, or Liechtenstein can use this platform
                to settle disputes arising from online contracts. You can access the platform <a
                    href="#">via the following
                    link</a>.</p>
